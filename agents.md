...
| [code-style/catalog-backed-accessors.md](docs/agents/code-style/catalog-backed-accessors.md) | PHP | reading a value out of `Hilos::$env` or `Hilos::$setting` in backend PHP — the one way in, and what is not a second one |
