...
/**
 * Moderator Object
 * Auto-generated from Entity: Demo\WebSocketTest\Database\Entity\Moderator
 *
 * @property-read ?int $idModerator
 * @property string $name
 * @property bool $checkAdultContent
 * @property bool $checkViolence
 * @property bool $checkProfanity
 * @property bool $checkSpam
 * @property bool $checkHateSpeech
 * @property int $sensitivityLevel
 * @property ?string $additionalRules
