-- Activates the framework hilos_verifier_circle table (HIL-643) for demo/cluster.
-- Copied from framework/backend/Database/Migration/Stub/create_hilos_verifier_circle.sql;
-- holds the people an operator named as verifiers of the system after a freeze, one row
-- per (identity_type, identifier) pair. It is created here because this demo can freeze
-- and the circle belongs to the freeze, not to the backup feature (HIL-1118).
