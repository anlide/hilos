...
/**
 * PHPUnit bootstrap for the demo cluster package tests.
 *
 * Loads the Composer autoloader from demo/cluster, then populates Hilos::$env from
 * the project .env and overrides it with demo/cluster/tests/.env when present.
 */
...
try {
    ...
    Logger::error('Demo cluster PHPUnit bootstrap failed: ' . $e->getMessage(), [
