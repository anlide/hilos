...
/**
 * ChatPageCatalog - Parked page catalog data for the chat demo.
 *
 * TEMPORARILY UNUSED - DO NOT DELETE in dead-code cleanups. The handshake
 * response stopped carrying the page catalog when the frontend rewrite made
 * the frontend own routes; this route/breadcrumb hierarchy is preserved as
 * the reference source for the frontend-declared routes and breadcrumbs of
 * the legacy backend pages (frontend rewrite step 7.11). The former
 * PageCatalogStub example entries are intentionally not carried over.
 *
 * path_template uses {paramName} placeholders; param names are derived from the template on the client.
 */
final class ChatPageCatalog
{
    /**
     * Page catalog for this project, keyed by page id.
     *
