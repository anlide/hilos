-- Reverts 042: puts the unfinished-registration memory back in its own table.
--
-- The CREATE is the text of the framework stub this table was activated from in 039,
-- reproduced here because that stub is gone with HIL-612 and a down migration has to
-- stand on its own.
