...
final class BotAgent extends AbstractLlmChatAgent
{
    ...
    private function buildGenerationMessages(ViewBot $bot): array
    {
        ...
        $systemParts[] = "Respond to what others said. Build on their ideas, challenge them, or agree"
            . " — but always in character. Do not speak in a vacuum.";
        $systemParts[] = "If a user (User#N) suggested a topic or expressed an opinion, engage with it"
            . " confidently — agree, challenge, or build on it. Stay in character.";
        $systemParts[] = "Be confident. Avoid hedging (maybe, perhaps, I think, I'm not sure). State your views directly in character.";
        $systemParts[] = "Prefer statements over questions. Do not end your message with a question mark."
            . " Contribute with assertions and opinions, not interrogations.";
