 ...
 * the {@see OAuthService} the `oauthStart`/`oauthCallback`
 * page actions run on, and the {@see OAuthProviderRegistry} the async
 * {@see OAuthAgent} drives. Which providers exist is {@see ChatOAuthProviderDirectory}'s;
...
final class ChatOAuthConfig
{
     ...
     *
     * The providers are ChatOAuthProviderDirectory's, in its order; each one's pair is what an
