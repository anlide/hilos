// The chat's HilosSettingsContext: binds the framework Hilos settings page
// (@hilos/vue HilosSettingsPage) to this project's connection, scope stores, and
// action lifecycle. The framework owns the table, the value cell, the row
