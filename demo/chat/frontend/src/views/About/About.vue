...
<template>
  <HilosStaticPage title="About">
    ...
    <p>
      It shows a live event stream, presence, bots, and file attachments wired
      through the Hilos signal protocol, driven by the same SDK that powers the
      React and Angular demos.
    </p>
    <p class="mb-0">
