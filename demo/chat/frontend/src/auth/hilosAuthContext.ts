// The chat's HilosAuthContext: binds the framework sign-in surface (@hilos/vue
// HilosAuthSurface) to this project's connection, scope stores, and action
// lifecycle, and declares the ways in this deployment offers. The framework owns
// the machine, the wire, the screens and the copy; the project supplies only where
// the data lives and what is enabled — and, on its backend, the handlers.
//
