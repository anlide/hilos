...
import HilosLogs from '@/views/Hilos/LogViewer/HilosLogs.vue'
import HilosLogsKeys from '@/views/Hilos/LogViewer/HilosLogsKeys.vue'
import HilosLogsWorkers from '@/views/Hilos/LogViewer/HilosLogsWorkers.vue'
import HilosLogsRotations from '@/views/Hilos/LogViewer/HilosLogsRotations.vue'
import HilosLogsView from '@/views/Hilos/LogViewer/HilosLogsView.vue'
