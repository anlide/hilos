...
// schemas, attaches the action-error store, and wires the stale-build reload;
// this file only states the project's endpoint policy and any project signals.
//
...
export const { connection, actionErrors } = createHilosConnection({
