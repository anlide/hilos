...
final class ChatTopologyRegistryTest extends TestCase
{
    ...
    public function testComputedPageActionRoutesMatchChatActionOwnership(): void
    {
        $this->assertSame([
            ...
            ChatSignalConstants::DETECT_IDENTIFIER => PageConstants::MAIN,
            ...
            ChatSignalConstants::ABANDON_REGISTRATION => PageConstants::MAIN,
    ...
    public function testComputedActionAgentRoutesUseOwningPageSubscriptionAgents(): void
    {
        $this->assertSame([
            ...
            ChatSignalConstants::DETECT_IDENTIFIER => AgentType::CHAT,
            ...
            ChatSignalConstants::ABANDON_REGISTRATION => AgentType::CHAT,
