...
//
// Only this stack's runner reaches the gateway (STAND_GATEWAY_URL and the CA it trusts are
// set on the chat e2e runner alone), so this helper has no twin in the other demos yet.
