...
/**
 * OAuthAgent - the simple-poll demo's concrete OAuth login agent (HIL-634).
 *
 ...
 *
 * {@see buildProviderRegistry()} names the providers from {@see PollOAuthConfig}.
...
final class OAuthAgent extends AbstractOAuthAgent
{
    ...
    {
        return PollOAuthConfig::buildProviderRegistry();
    }
