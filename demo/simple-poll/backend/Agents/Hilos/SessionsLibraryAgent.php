...
/**
 * The poll demo's sessions library - and the one seam a project can be asked to answer.
 *
 ...
 * which is also what makes the handshake arrive here rather than in {@see PollAgent}.
 */
