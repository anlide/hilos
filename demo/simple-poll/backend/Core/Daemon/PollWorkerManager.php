...
use Demo\SimplePoll\Core\Agent\PollAgentManager;
...
/**
 * PollWorkerManager - Worker manager for the simple-poll demo.
 *
 ...
 */
final class PollWorkerManager extends WorkerManager
{
    /**
     ...
     *
     * @return AgentManager Poll agent manager instance
     */
    protected function createAgentManager(): AgentManager
    {
        return new PollAgentManager();
    }
