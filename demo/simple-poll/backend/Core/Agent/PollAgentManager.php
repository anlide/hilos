...
namespace Demo\SimplePoll\Core\Agent;
...
/**
 * PollAgentManager - Agent manager for the simple-poll demo (worker side).
 *
 * Extends base AgentManager to provide demo-specific agent creation.
 */
final class PollAgentManager extends AgentManager
{
    /**
