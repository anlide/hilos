...
use Demo\SimplePoll\Database\Entity\Collection\Guests as EntityGuests;
use Demo\SimplePoll\Database\Entity\Item\Guest as EntityGuest;
use Demo\SimplePoll\Database\Object\Item\Guest as ObjectGuest;
...
final class Guests extends Objects
{
    ...
    public const string COLLECTION_KEY = PollDbContext::guests;
