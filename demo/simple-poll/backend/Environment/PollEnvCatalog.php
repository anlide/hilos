...
final class PollEnvCatalog implements CatalogProviderInterface
{
    ...
    public static function getCatalog(): array
    {
        return array_replace(EnvCatalogStub::getCatalog(), [
            EnvConstants::DB_DATABASE->name => self::stringEntry('hilos-demo-simple-poll', emptyIsMissing: true),
            PollEnvConstants::OAUTH_STATE_SECRET => self::stringEntry(
                'dev-oauth-state-secret-change-me',
                emptyIsMissing: true,
            ),
            PollEnvConstants::OAUTH_GITHUB_CLIENT_ID => self::stringEntry(''),
            PollEnvConstants::OAUTH_GITHUB_CLIENT_SECRET => self::stringEntry(''),
            PollEnvConstants::OAUTH_GOOGLE_CLIENT_ID => self::stringEntry(''),
            PollEnvConstants::OAUTH_GOOGLE_CLIENT_SECRET => self::stringEntry(''),
            PollEnvConstants::OAUTH_REDIRECT_URI => self::stringEntry(
                '/auth/callback',
                emptyIsMissing: true,
            ),
        ]);
