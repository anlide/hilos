...
/**
 * Integration test: simple-poll demo Entity metadata against the live database
 * schema.
 *
...
final class EntitySchemaConsistencyTest extends IntegrationTestCase
{
    ...
    private const string OWN_ENTITY_NAMESPACE = 'Demo\\SimplePoll\\Database\\Entity\\Item\\';
