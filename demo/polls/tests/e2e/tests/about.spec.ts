...
// nothing else for this spec to wait on. This is also the only proof the Angular
// pair has: the SDK's Angular surface is checked by this demo's e2e, not by a
// unit test.
