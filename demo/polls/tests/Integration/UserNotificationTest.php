...
use Demo\Polls\Constants\PollsNotificationType;
...
final class UserNotificationTest extends IntegrationTestCase
{
    ...
    public function testARenamedUserIsToldWhoTheyAreNow(): void
    {
        ...
        self::assertSame(PollsNotificationType::USER_RENAMED, $notification->type);
    ...
    private function deleteDemoNotifications(): void
    {
        Database::sql(
            ...
            . ' WHERE `' . EntityNotification::type . '` LIKE \'polls.%\'',
        );
    }
}
