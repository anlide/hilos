...
abstract class IntegrationTestCase extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        TruthSourceRegistry::register(PollsDbContext::users, true, self::TEST_AGENT_ID);
        TruthSourceRegistry::register(PollsDbContext::userRenames, true, self::TEST_AGENT_ID);
        TruthSourceRegistry::register(PollsDbContext::guests, true, self::TEST_AGENT_ID);
