...
/**
 * PollsNotificationType - the notification types this demo raises from its own domain (HIL-557).
 *
 ...
 * (HIL-611) - a notification is addressed to a user id, and a guest has none. Names
 ...
 */
final class PollsNotificationType
{
    /** An administrator renamed the recipient's account. */
    public const string USER_RENAMED = 'polls.user.renamed';
}
