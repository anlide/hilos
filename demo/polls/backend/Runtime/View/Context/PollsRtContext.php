...
namespace Demo\Polls\Runtime\View\Context;

use Demo\Polls\Runtime\State\Collection\Connections as StateConnections;
use Demo\Polls\Runtime\View\Actions\Collection\ConnectionsActions;
use Demo\Polls\Runtime\View\Actions\Item\ConnectionActions;
use Demo\Polls\Runtime\View\Collection\Connections;
use Hilos\Runtime\Exception\Rt\StateCollectionNotFoundException;
use Hilos\Runtime\View\Context\RtContext;

/**
 * PollsRtContext - polls runtime context.
 *
 ...
 */
final class PollsRtContext extends RtContext
{
