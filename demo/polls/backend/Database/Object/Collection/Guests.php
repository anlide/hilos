...
use Demo\Polls\Database\Entity\Collection\Guests as EntityGuests;
use Demo\Polls\Database\Entity\Item\Guest as EntityGuest;
use Demo\Polls\Database\Object\Item\Guest as ObjectGuest;
...
final class Guests extends Objects
{
    ...
    public const string COLLECTION_KEY = PollsDbContext::guests;
