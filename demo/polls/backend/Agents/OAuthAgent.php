...
/**
 * OAuthAgent - the polls demo's concrete OAuth login agent (HIL-634).
 *
 ...
 *
 * {@see buildProviderRegistry()} names the providers from {@see PollsOAuthConfig}.
...
final class OAuthAgent extends AbstractOAuthAgent
{
    ...
    {
        return PollsOAuthConfig::buildProviderRegistry();
    }
