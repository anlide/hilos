...
/**
 * PHPUnit bootstrap for the demo polls package tests.
 *
 * Loads the Composer autoloader from demo/polls, then populates the
 * Hilos env accessor (Hilos::$env) from the project .env and overrides it with
 * demo/polls/tests/.env when present. Values are read through
...
try {
    ...
    Logger::error('Demo polls PHPUnit bootstrap failed: ' . $e->getMessage(), [
