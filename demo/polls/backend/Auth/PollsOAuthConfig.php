 ...
 * {@see OAuthAgent} drives. Which providers exist is {@see PollsOAuthProviderDirectory}'s;
...
final class PollsOAuthConfig
{
    ...
    {
        $appSecret = Hilos::$env[PollsEnvConstants::OAUTH_STATE_SECRET]->string();
     ...
     *
     * The providers are PollsOAuthProviderDirectory's, in its order; each one's pair is what an
