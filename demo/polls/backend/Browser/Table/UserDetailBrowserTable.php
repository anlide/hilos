...
namespace Demo\Polls\Browser\Table;
...
{
    public const string TABLE = PollsBrowserTable::USER_DETAIL;
    ...
    public const array BROWSER = [
        ...
        BrowserTableConfigKey::ROWS => [
            [
                BrowserTableFieldKey::SOURCE => PollsBrowserSource::DB_USERS,
                BrowserTableFieldKey::ROW_KEY => User::id,
                BrowserTableFieldKey::WHERE => [
                    User::id => PollsBrowserRef::TABLE_HILOS_USER_ID,
                ],
            ...
            [
                ...
                BrowserTableFieldKey::WHERE => [
                    Connection::userId => PollsBrowserRef::TABLE_HILOS_USER_ID,
                ],
                BrowserTableFieldKey::FIELDS => [
                    Connection::userId,
                ],
