...
namespace Demo\Polls\Core\Socket\Client;
...
/**
 * PollsWebSocketClient - WebSocket client for the polls demo.
 *
 ...
 */
final class PollsWebSocketClient extends WebSocketClient
{
    /**
    ...
    protected function onHandshake(
        ...
        // No additional handshake handling needed for the polls demo
    }
}
