// The visitor's display name (HIL-611): this demo's own answer to "who am I"
...
// `PollsSignalConstants::GUEST_IDENTITY` constant.
import {
  createSignal,
  z,
...
/** Signal `type` for the guest identity (PHP `PollsSignalConstants::GUEST_IDENTITY`). */
