// The polls page routes: the cold-load route registry the navigator resolves a
// URL against. The route engine and the framework admin catalog come from
// @hilos/core, so this file only declares the polls demo's own pages;
...
/**
 * The polls demo's own pages keyed to the URL path template each answers and
...
/**
 * The polls page router: the application pages plus the framework admin catalog,
