...
/**
 * TasksLegalCatalog - The tasks demo's legal documents: a project that departs from nothing.
 *
 ...
 */
final class TasksLegalCatalog implements LegalCatalogProviderInterface
{
