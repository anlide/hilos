...
final class TasksAgent extends AbstractAgent
{
    ...
    public function onSignalHandshake(WebSocketHandshakeSignalDTO $data, string $source, string $name): void
    {
        ...
        $this->sendToUser(
            TasksSignalConstants::HANDSHAKE_RESPONSE,
            $data->acceptKey,
    ...
    /**
     * Returns the tasks handshake-response signal name the {@see HilosSessionHost}
     * seam emits under; the frontend routes on this project constant.
     *
     * @return string Tasks handshake-response signal name
     */
    protected function handshakeResponseSignalName(): string
    {
        return TasksSignalConstants::HANDSHAKE_RESPONSE;
    }
