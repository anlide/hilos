...
/**
 * TasksAuthMethods - the auth methods this demo has actually wired (HIL-623).
 *
 ...
 * users library carries, and the OAuth keys come out of {@see TasksOAuthConfig}'s own
...
final class TasksAuthMethods
{
    ...
    public static function enabledKeys(): array
    {
        return [
            ...
            AuthMethodKey::SMS,
            ...TasksOAuthConfig::buildProviderRegistry()->keys(),
        ];
    }
