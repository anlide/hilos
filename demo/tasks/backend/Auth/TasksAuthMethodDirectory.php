...
/**
 * TasksAuthMethodDirectory - the sign-in methods this demo has wired (HIL-623, HIL-427).
 *
 ...
 * switched off here. The providers come from {@see TasksOAuthProviderDirectory}, whose
 * order is the order of their icons, so adding a provider there adds it here with nothing
 * to keep in step.
 */
final class TasksAuthMethodDirectory extends AuthMethodDirectory
{
    /**
