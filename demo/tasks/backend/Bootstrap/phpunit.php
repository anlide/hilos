...
/**
 * PHPUnit bootstrap for the demo tasks package tests.
 *
 * Loads the Composer autoloader from demo/tasks, then populates the
 * Hilos env accessor (Hilos::$env) from the project .env and overrides it with
 * demo/tasks/tests/.env when present. Values are read through
...
try {
    ...
    Logger::error('Demo tasks PHPUnit bootstrap failed: ' . $e->getMessage(), [
