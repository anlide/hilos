...
/**
 * Tasks demo project-specific environment keys.
 *
 * The names are literally the ones the chat demo uses: these describe the same
 * external provider, and two demos spelling one provider's credentials differently
 * would cost every reader a comparison.
 */
final class TasksEnvConstants
{
    /**
