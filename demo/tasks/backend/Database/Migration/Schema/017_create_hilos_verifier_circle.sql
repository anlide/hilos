-- Activates the framework hilos_verifier_circle table (HIL-643) for demo/tasks.
...
-- per (identity_type, identifier) pair. It is created here because this demo declares the
-- backup feature (HIL-911), and the feature refuses to start without the table.
