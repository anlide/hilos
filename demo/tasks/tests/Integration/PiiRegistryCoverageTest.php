 ...
 *
 * The same test the chat demo keeps, because the obligation comes with the feature and not
 * with the demo: this one declares backup too (HIL-911), and its node refuses to start on a
 * schema the startup gate below would refuse.
 */
final class PiiRegistryCoverageTest extends IntegrationTestCase
{
     ...
     */
    private const int MIN_PASS_STATEMENT_COUNT = 12;
