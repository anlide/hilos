...
/**
 * Snapshot of what the tasks demo publishes as legal documents.
 *
 ...
 */
final class TasksLegalCatalogSnapshotTest extends TestCase
{
    ...
    {
        self::assertSame(TasksLegalCatalog::class, Hilos::legalCatalogClass());
    }
    ...
    /**
     * The tasks demo departs from nothing: every clause of both documents is the standard one.
     */
