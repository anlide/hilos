// The todo session identity (session bootstrap): a client-minted persistent
...
/** Concrete todo signal schemas for the core parse boundary. */
export const todoSignalSchemas = {
