// The todo page configuration: the cold-load route registry and the per-signal
...
// from @hilos/core so this file only declares the todo's own pages and merges.
import {
  createPageRouter,
  pageResponseSchema,
  HILOS_PAGE_ROUTES,
...
/** Concrete todo page signal schemas for the core parse boundary. */
