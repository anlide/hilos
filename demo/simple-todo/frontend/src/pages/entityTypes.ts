// The todo page payloads' entity-slot types: which payload slots are entities and
...
// is its backend collection name (`TodoDbContext::*`); the canonical type makes a
...
/** Per-slot canonical entity types for the todo's page payloads. */
