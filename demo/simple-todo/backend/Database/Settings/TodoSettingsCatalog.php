...
namespace Demo\SimpleTodo\Database\Settings;

use Hilos\Core\Catalog\CatalogProviderInterface;
use Hilos\Database\Settings\SettingsCatalogConstants;

/**
 * TodoSettingsCatalog - Project settings catalog for the simple-todo demo.
 *
 ...
 */
final class TodoSettingsCatalog implements CatalogProviderInterface
{
    /**
     * Returns the settings catalog for the simple-todo demo.
     *
