...
use Demo\SimpleTodo\Database\Entity\Collection\Guests as EntityGuests;
...
/**
 * Guests - Object collection for todo guests.
 *
...
final class Guests extends Objects
{
    ...
    public const string COLLECTION_KEY = TodoDbContext::guests;
