...
/**
 * PHPUnit bootstrap for the demo simple-todo package tests.
 *
 * Loads the Composer autoloader from demo/simple-todo, then populates the
 * Hilos env accessor (Hilos::$env) from the project .env and overrides it with
 * demo/simple-todo/tests/.env when present. Values are read through
...
try {
    ...
    Logger::error('Demo simple-todo PHPUnit bootstrap failed: ' . $e->getMessage(), [
