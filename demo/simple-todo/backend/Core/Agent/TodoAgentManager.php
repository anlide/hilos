...
namespace Demo\SimpleTodo\Core\Agent;
...
/**
 * TodoAgentManager - Agent manager for the simple-todo demo (worker side).
 *
 * Extends base AgentManager to provide demo-specific agent creation.
 */
final class TodoAgentManager extends AgentManager
{
    /**
