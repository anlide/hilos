...
namespace Demo\SimpleTodo\Core\Socket\Client;
...
/**
 * TodoWebSocketClient - WebSocket client for the simple-todo demo.
 *
 * Validates incoming page actions against the project topology; the framework
 * base class handles the handshake (welcome frame, connection id mint) itself.
 */
final class TodoWebSocketClient extends WebSocketClient
{
    /**
    ...
    protected function onHandshake(
        ...
        // No additional handshake handling needed for the simple-todo demo
    }
}
