...
final class BackupAgent extends AbstractAgent implements DeferredQueueHandoverSink
{
     ...
     * one. A moment later the child starts replacing it. The verifier circle is photographed
     * already: the worker's ready relay takes it before calling this hook (HIL-1118).
     *
