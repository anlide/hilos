...
/**
 * Immutable read model of one failure line kept for the "recent errors" panel (HIL-867).
 *
 * Produced by {@see LogErrorTailReader} from the tail of one live error stream and carried through
...
final class LogErrorEntry
{
     ...
     * @param string $message Line text without its timestamp and context, already cut to the reader's limit
