...
class HilosBackupHistoryTable extends TableDefinition implements ViewportTable
{
    ...
    /**
     * Answers whether one backup row is in the set a window of this table shows.
     *
     * The set is built the way {@see query()} builds it - the stored index narrowed by this list's filters - and searched the
