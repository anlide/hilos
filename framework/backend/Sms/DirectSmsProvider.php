 ...
 *
 * The offline counterpart of {@see HttpSmsProvider}: it resolves the send
 * synchronously with no network I/O. {@see StubSmsProvider} is the one
 * implementation - it writes a masked log line instead of calling a gateway, so
 * a project with no gateway configured still runs.
 */
