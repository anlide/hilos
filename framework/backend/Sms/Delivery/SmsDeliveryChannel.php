    ...
    public function configFields(): array
    {
        return [
            new ChannelConfigField(
                ...
                false,
                EnvConstants::SMS_FROM,
            ),
            new ChannelConfigField(
                self::FIELD_ENDPOINT_URL,
                'Gateway endpoint URL',
                SettingsCatalogConstants::TYPE_STRING,
                false,
                EnvConstants::SMS_ENDPOINT_URL,
            ),
            new ChannelConfigField(
                self::FIELD_HTTP_METHOD,
                'HTTP method',
                SettingsCatalogConstants::TYPE_STRING,
                false,
                null,
                self::DEFAULT_HTTP_METHOD,
                ChannelConfigValidators::httpMethod(...),
            ),
            new ChannelConfigField(
                self::FIELD_AUTH_MODE,
                'Auth mode',
                SettingsCatalogConstants::TYPE_STRING,
                false,
                null,
                self::DEFAULT_AUTH_MODE,
                ChannelConfigValidators::smsAuthMode(...),
            ),
            new ChannelConfigField(
                self::FIELD_FIELD_MAP,
                'Field map (JSON)',
                SettingsCatalogConstants::TYPE_STRING,
                false,
                null,
                self::DEFAULT_FIELD_MAP,
                ChannelConfigValidators::jsonObject(...),
            ),
            new ChannelConfigField(
                self::FIELD_SUCCESS_RULE,
                'Success rule',
                SettingsCatalogConstants::TYPE_STRING,
                false,
                null,
            ...
            new ChannelConfigField(
                ...
                false,
                EnvConstants::SMS_TIMEOUT_MS,
                10000,
            ),
            new ChannelConfigField(
                self::FIELD_MAX_LENGTH,
                'Max length (GSM-7 chars)',
                SettingsCatalogConstants::TYPE_INTEGER,
                false,
                null,
