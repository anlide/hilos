...
trait EntityCollectionFixer
{
    ...
    protected function createEntityCollectionFile(string $entityClassName, string $entityCollectionDir, string $namespace, ReflectionClass $entityReflection): bool
    {
        ...
        $content .= " * while extending EntityCollection.\n";
        $content .= " *\n";
        ...
        $content .= "    {\n";
        $content .= "        return self::fromEntityCollection({$entityAlias}::getAll());\n";
        $content .= "    }\n\n";
        $content .= "    /**\n";
        ...
        $content .= "    {\n";
        $content .= "        \$result = new self();\n";
        $content .= "        foreach (\$collection as \$key => \$entity) {\n";
        $content .= "            \$result[\$key] = \$entity;\n";
        $content .= "        }\n";
        ...
        $content .= "    {\n";
        $content .= "        \$entity = parent::offsetGet(\$offset);\n";
        $content .= "        return \$entity instanceof {$entityAlias} ? \$entity : null;\n";
        $content .= "    }\n\n";
        $content .= "    /**\n";
        ...
        $content .= "            parent::offsetSet(\$offset, \$value);\n";
        $content .= "        }\n";
        $content .= "    }\n";
        $content .= "}\n";
