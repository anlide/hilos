...
class CliManager
{
    ...
    private function registerCommands(): void
    {
        ...
        $this->commands[CliCommands::CLUSTER_TLS_CA] = new ClusterTlsCaCommand();
        $this->commands[CliCommands::CLUSTER_TLS_ISSUE] = new ClusterTlsIssueCommand();
        $this->commands[CliCommands::CLUSTER_TLS_TRUST] = new ClusterTlsTrustCommand();
        ...
        $this->commands[CliCommands::PROTECTED_MODE_INSPECT] = new ProtectedModeInspectCommand();
