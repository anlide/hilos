...
use Hilos\Socket\Exception\WebSocket\HandshakeFailedException;
use Hilos\Socket\Exception\WebSocket\InvalidFrameException;
use Hilos\Socket\Exception\WebSocket\InvalidFrameSequenceException;
use Hilos\Socket\Exception\WebSocket\ReservedOpcodeException;
use Hilos\Socket\Exception\WebSocket\UnknownOpcodeException;
use Hilos\Socket\Exception\WebSocket\UnsupportedProtocolVersionException;
