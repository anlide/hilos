...
const envSchema = z.object({
  ...
  AGENT_CLAUDE_REPORTS_DIR: z.string().trim().default('/data/reports'),
  AGENT_CLAUDE_FINGERPRINT_FILE: z.string().trim().default('/data/fingerprints.json'),
...
export function loadMcpRuntimeConfig(): McpRuntimeConfig {
  ...
  return {
    workspaceRoot,
    allowedRoots,
    reportsDir: path.resolve(parsed.AGENT_CLAUDE_REPORTS_DIR),
    fingerprintFile: path.resolve(parsed.AGENT_CLAUDE_FINGERPRINT_FILE),
