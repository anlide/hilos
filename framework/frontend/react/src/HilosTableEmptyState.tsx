...
// window, not a button.
// Internal to the React view layer on purpose: it is not exported from
...
export function HilosTableEmptyState<R>({
  ...
  if (kind === 'empty_page') {
    return (
      ...
      >
        <i
          className="bi bi-arrow-left-circle fs-1 text-body-secondary mb-2 d-block"
          aria-hidden="true"
        />
        <div className="fw-semibold small mb-1">Nothing on this page</div>
    ...
    return (
      ...
      >
        <span
          ...
          aria-hidden="true"
        >
          <i className="bi bi-gear fs-1 text-warning" />
          <i className="bi bi-exclamation-circle-fill text-danger position-absolute hilos-table-unavailable-mark" />
        </span>
        <div
