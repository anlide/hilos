// HilosLogsWorkersPage — the Logs Workers admin page (HilosPages.LOGS_WORKERS). A framework default: a
...
/** The Logs Workers admin page: the framework default shell for its key. */
export function HilosLogsWorkersPage() {
  return <HilosAdminPage page={HilosPages.LOGS_WORKERS} />
}
