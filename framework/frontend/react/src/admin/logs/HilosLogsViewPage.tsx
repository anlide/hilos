// HilosLogsViewPage — the Logs View admin page (HilosPages.LOGS_VIEW). A framework default: a
...
/** The Logs View admin page: the framework default shell for its key. */
export function HilosLogsViewPage() {
  return <HilosAdminPage page={HilosPages.LOGS_VIEW} />
}
