// HilosSecurityOauthProviderPage — the Security Oauth Provider admin page (HilosPages.SECURITY_OAUTH_PROVIDER). A framework default: a
...
/** The Security Oauth Provider admin page: the framework default shell for its key. */
export function HilosSecurityOauthProviderPage() {
  return <HilosAdminPage page={HilosPages.SECURITY_OAUTH_PROVIDER} />
}
