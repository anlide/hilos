// HilosSecurityOauthPage — the Security Oauth admin page (HilosPages.SECURITY_OAUTH). A framework default: a
...
/** The Security Oauth admin page: the framework default shell for its key. */
export function HilosSecurityOauthPage() {
  return <HilosAdminPage page={HilosPages.SECURITY_OAUTH} />
}
