// HilosSecurity2faPage — the Security2fa admin page (HilosPages.SECURITY_2FA). A framework default: a
...
/** The Security2fa admin page: the framework default shell for its key. */
export function HilosSecurity2faPage() {
  return <HilosAdminPage page={HilosPages.SECURITY_2FA} />
}
