// HilosCommunicationsChannelPage — the Communications Channel admin page (HilosPages.COMMUNICATIONS_CHANNEL). A framework default: a
...
/** The Communications Channel admin page: the framework default shell for its key. */
export function HilosCommunicationsChannelPage() {
  return <HilosAdminPage page={HilosPages.COMMUNICATIONS_CHANNEL} />
}
