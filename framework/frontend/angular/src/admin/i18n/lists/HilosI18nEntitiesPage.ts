// HilosI18nEntitiesPage — the I18n Entities admin page (HilosPages.I18N_ENTITIES). A framework default: a
...
/** The I18n Entities admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-entities-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nEntitiesPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_ENTITIES
}
