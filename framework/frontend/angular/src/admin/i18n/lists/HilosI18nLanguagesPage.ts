// HilosI18nLanguagesPage — the I18n Languages admin page (HilosPages.I18N_LANGUAGES). A framework default: a
...
/** The I18n Languages admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-languages-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nLanguagesPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_LANGUAGES
}
