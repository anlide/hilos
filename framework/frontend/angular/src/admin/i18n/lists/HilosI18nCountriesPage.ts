// HilosI18nCountriesPage — the I18n Countries admin page (HilosPages.I18N_COUNTRIES). A framework default: a
...
/** The I18n Countries admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-countries-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nCountriesPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_COUNTRIES
}
