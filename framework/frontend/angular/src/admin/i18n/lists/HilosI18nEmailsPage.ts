// HilosI18nEmailsPage — the I18n Emails admin page (HilosPages.I18N_EMAILS). A framework default: a
...
/** The I18n Emails admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-emails-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nEmailsPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_EMAILS
}
