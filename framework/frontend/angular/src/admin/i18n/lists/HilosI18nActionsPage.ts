// HilosI18nActionsPage — the I18n Actions admin page (HilosPages.I18N_ACTIONS). A framework default: a
...
/** The I18n Actions admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-actions-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nActionsPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_ACTIONS
}
