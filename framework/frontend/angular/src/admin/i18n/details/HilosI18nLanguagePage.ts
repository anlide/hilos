// HilosI18nLanguagePage — the I18n Language admin page (HilosPages.I18N_LANGUAGE). A framework default: a
...
/** The I18n Language admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-language-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nLanguagePage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_LANGUAGE
}
