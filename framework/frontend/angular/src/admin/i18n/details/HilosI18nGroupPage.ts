// HilosI18nGroupPage — the I18n Group admin page (HilosPages.I18N_GROUP). A framework default: a
...
/** The I18n Group admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-group-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nGroupPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_GROUP
}
