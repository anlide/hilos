// HilosI18nCountryPage — the I18n Country admin page (HilosPages.I18N_COUNTRY). A framework default: a
...
/** The I18n Country admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-country-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nCountryPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_COUNTRY
}
