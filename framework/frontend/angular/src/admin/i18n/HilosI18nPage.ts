// HilosI18nPage — the I18n admin page (HilosPages.I18N). A framework default: a
...
/** The I18n admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N
}
