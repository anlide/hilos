// HilosI18nTranslateEntityPage — the I18n Translate Entity admin page (HilosPages.I18N_TRANSLATE_ENTITY). A framework default: a
...
/** The I18n Translate Entity admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-translate-entity-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nTranslateEntityPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_TRANSLATE_ENTITY
}
