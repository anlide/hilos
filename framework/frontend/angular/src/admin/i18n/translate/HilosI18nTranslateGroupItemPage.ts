// HilosI18nTranslateGroupItemPage — the I18n Translate Group Item admin page (HilosPages.I18N_TRANSLATE_GROUP_ITEM). A framework default: a
...
/** The I18n Translate Group Item admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-translate-group-item-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nTranslateGroupItemPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_TRANSLATE_GROUP_ITEM
}
