// HilosI18nTranslateUiPageItemPage — the I18n Translate Ui Page Item admin page (HilosPages.I18N_TRANSLATE_UI_PAGE_ITEM). A framework default: a
...
/** The I18n Translate Ui Page Item admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-translate-ui-page-item-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nTranslateUiPageItemPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_TRANSLATE_UI_PAGE_ITEM
}
