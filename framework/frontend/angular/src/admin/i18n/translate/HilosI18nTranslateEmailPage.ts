// HilosI18nTranslateEmailPage — the I18n Translate Email admin page (HilosPages.I18N_TRANSLATE_EMAIL). A framework default: a
...
/** The I18n Translate Email admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-i18n-translate-email-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosI18nTranslateEmailPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.I18N_TRANSLATE_EMAIL
}
