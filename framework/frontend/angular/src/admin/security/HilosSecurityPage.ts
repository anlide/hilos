// HilosSecurityPage — the Security admin page (HilosPages.SECURITY). A framework default: a
...
/** The Security admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-security-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosSecurityPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.SECURITY
}
