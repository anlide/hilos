// HilosBillingProviderPage — the Billing Provider admin page (HilosPages.BILLING_PROVIDER). A framework default: a
...
/** The Billing Provider admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-billing-provider-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosBillingProviderPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.BILLING_PROVIDER
}
