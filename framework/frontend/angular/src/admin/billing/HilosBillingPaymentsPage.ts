// HilosBillingPaymentsPage — the Billing Payments admin page (HilosPages.BILLING_PAYMENTS). A framework default: a
...
/** The Billing Payments admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-billing-payments-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosBillingPaymentsPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.BILLING_PAYMENTS
}
