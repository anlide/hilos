...
/** The Billing admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-billing-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosBillingPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.BILLING
}
