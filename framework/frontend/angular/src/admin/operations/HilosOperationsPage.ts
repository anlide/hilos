...
/** The Operations admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-operations-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosOperationsPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.OPERATIONS
}
