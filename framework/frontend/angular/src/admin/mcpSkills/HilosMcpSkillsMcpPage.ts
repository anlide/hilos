// HilosMcpSkillsMcpPage — the Mcp Skills Mcp admin page (HilosPages.MCP_SKILLS_MCP). A framework default: a
...
/** The Mcp Skills Mcp admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-mcp-skills-mcp-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosMcpSkillsMcpPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.MCP_SKILLS_MCP
}
