...
/** The Mcp Skills admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-mcp-skills-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosMcpSkillsPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.MCP_SKILLS
}
