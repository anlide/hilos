// HilosChangeLogTablesPage — the Change Log Tables admin page (HilosPages.CHANGE_LOG_TABLES). A framework default: a
...
/** The Change Log Tables admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-change-log-tables-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosChangeLogTablesPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.CHANGE_LOG_TABLES
}
