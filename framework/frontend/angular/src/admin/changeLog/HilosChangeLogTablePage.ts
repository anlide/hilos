// HilosChangeLogTablePage — the Change Log Table admin page (HilosPages.CHANGE_LOG_TABLE). A framework default: a
...
/** The Change Log Table admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-change-log-table-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosChangeLogTablePage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.CHANGE_LOG_TABLE
}
