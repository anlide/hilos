// HilosDaemonCronPage — the Daemon Cron admin page (HilosPages.DAEMON_CRON). A framework default: a
...
/** The Daemon Cron admin page: the framework default shell for its key. */
@Component({
  selector: 'hilos-daemon-cron-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [HilosAdminPage],
  template: `<hilos-admin-page [page]="page" />`,
})
export class HilosDaemonCronPage {
  /** The admin page key this default renders the shell for. */
  protected readonly page = HilosPages.DAEMON_CRON
}
