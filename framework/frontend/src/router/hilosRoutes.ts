 ...
 */
export function createHilosRoutes(): RouteRecordRaw[] {
  return [
    {
      path: 'hilos',
      name: 'hilos',
      component: () => import('../views/Hilos/HilosDashboard.vue'),
      meta: { page: 'hilos' },
    },
    {
      path: 'hilos/users/:userId',
      name: 'hilos_user',
      component: () => import('../views/Hilos/HilosUserDetail.vue'),
      meta: { page: 'hilos_user' },
    },
    {
      path: 'hilos/users',
      name: 'hilos_users',
      component: () => import('../views/Hilos/HilosUsers.vue'),
      meta: { page: 'hilos_users' },
    },
    {
      path: 'hilos/operations',
      name: 'hilos_operations',
      component: () => import('../views/Hilos/HilosOperations.vue'),
      meta: { page: 'hilos_operations' },
    },
    {
      path: 'hilos/roles',
      name: 'hilos_roles',
      component: () => import('../views/Hilos/HilosRoles.vue'),
      meta: { page: 'hilos_roles' },
    },
    {
      path: 'hilos/backup',
      name: 'hilos_backup',
      component: () => import('../views/Hilos/Backup/HilosBackup.vue'),
      meta: { page: 'hilos_backup' },
    },
    {
      path: 'hilos/change-log/tables/:tableId',
      name: 'hilos_change_log_table',
      component: () => import('../views/Hilos/ChangeLog/HilosChangeLogTable.vue'),
      meta: { page: 'hilos_change_log_table' },
    },
    {
      path: 'hilos/change-log/tables',
      name: 'hilos_change_log_tables',
      component: () => import('../views/Hilos/ChangeLog/HilosChangeLogTables.vue'),
      meta: { page: 'hilos_change_log_tables' },
    },
    {
      path: 'hilos/change-log',
      name: 'hilos_change_log',
      component: () => import('../views/Hilos/ChangeLog/HilosChangeLogDashboard.vue'),
      meta: { page: 'hilos_change_log' },
    },
    {
      path: 'hilos/daemon/http/:serverId',
      name: 'hilos_daemon_http_server',
      component: () => import('../views/Hilos/Daemon/HilosDaemonHttpServer.vue'),
      meta: { page: 'hilos_daemon_http_server' },
    },
    {
      path: 'hilos/daemon/workers',
      name: 'hilos_daemon_workers',
      component: () => import('../views/Hilos/Daemon/HilosDaemonWorkers.vue'),
      meta: { page: 'hilos_daemon_workers' },
    },
    {
      path: 'hilos/daemon/agents',
      name: 'hilos_daemon_agents',
      component: () => import('../views/Hilos/Daemon/HilosDaemonAgents.vue'),
      meta: { page: 'hilos_daemon_agents' },
    },
    {
      path: 'hilos/daemon/cron',
      name: 'hilos_daemon_cron',
      component: () => import('../views/Hilos/Daemon/HilosDaemonCron.vue'),
      meta: { page: 'hilos_daemon_cron' },
    },
    {
      path: 'hilos/daemon/websockets',
      name: 'hilos_daemon_websockets',
      component: () => import('../views/Hilos/Daemon/HilosDaemonWebsockets.vue'),
      meta: { page: 'hilos_daemon_websockets' },
    },
    {
      path: 'hilos/daemon',
      name: 'hilos_daemon',
      component: () => import('../views/Hilos/Daemon/HilosDaemon.vue'),
      meta: { page: 'hilos_daemon' },
    },
    {
      path: 'hilos/logs/view',
      name: 'hilos_logs_view',
      component: () => import('../views/Hilos/LogViewer/HilosLogsView.vue'),
      meta: { page: 'hilos_logs_view' },
    },
    {
      path: 'hilos/logs/keys',
      name: 'hilos_logs_keys',
      component: () => import('../views/Hilos/LogViewer/HilosLogsKeys.vue'),
      meta: { page: 'hilos_logs_keys' },
    },
    {
      path: 'hilos/logs/workers',
      name: 'hilos_logs_workers',
      component: () => import('../views/Hilos/LogViewer/HilosLogsWorkers.vue'),
      meta: { page: 'hilos_logs_workers' },
    },
    {
      path: 'hilos/logs/rotations',
      name: 'hilos_logs_rotations',
      component: () => import('../views/Hilos/LogViewer/HilosLogsRotations.vue'),
      meta: { page: 'hilos_logs_rotations' },
    },
    {
      path: 'hilos/logs',
      name: 'hilos_logs',
      component: () => import('../views/Hilos/LogViewer/HilosLogs.vue'),
      meta: { page: 'hilos_logs' },
    },
    {
      path: 'hilos/settings',
      name: 'hilos_settings',
      component: () => import('../views/Hilos/HilosSettings.vue'),
      meta: { page: 'hilos_settings' },
    },
    {
      path: 'hilos/i18n',
      name: 'hilos_i18n',
      component: () => import('../views/Hilos/HilosI18n.vue'),
      meta: { page: 'hilos_i18n' },
    },
    {
      path: 'hilos/i18n/translate/ui-page/:uiPageId/item/:itemId',
      name: 'hilos_i18n_translate_ui_page_item',
      component: () => import('../views/Hilos/I18n/Translate/HilosI18nTranslateUiPageItem.vue'),
    ...
    },
    {
      ...
      component: () => import('../views/Hilos/I18n/Translate/HilosI18nTranslateGroupItem.vue'),
