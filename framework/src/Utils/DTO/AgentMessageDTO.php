...
/**
 * AgentMessageDTO - Data Transfer Object for agent messages
 *
 * Used for communication between daemon and worker processes.
 * Supports different message types: agent_start, agent_stop, agent_message.
 */
class AgentMessageDTO extends BaseDTO
{
    ...
    public const string TYPE_AGENT_MESSAGE = 'agent_message';

    // Actions (for TYPE_AGENT_MESSAGE)
