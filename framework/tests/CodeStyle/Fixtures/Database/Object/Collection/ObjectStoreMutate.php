 ...
 * announced and every view goes on answering out of its cache. Each of the four lines
...
{
    /**
     * @param int|string $key Key written, appended to, dropped and then wiped along with the rest
