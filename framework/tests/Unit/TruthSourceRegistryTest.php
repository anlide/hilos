...
final class TruthSourceRegistryTest extends TestCase
{
    ...
    public function testCurrentAgentCanWriteOnlyRegisteredDbItemKey(): void
    {
        ...
        TruthSourceRegistry::checkCanWriteItem(self::COLLECTION, '2', static fn(): array => [], TruthSourceOperation::Update);
    }
    ...
    public function testCollectionWideDbSourceCanWriteAnyItemKey(): void
    {
        ...
        TruthSourceRegistry::checkCanWrite(self::COLLECTION, TruthSourceOperation::Update);
        TruthSourceRegistry::checkCanWriteItem(self::COLLECTION, '1', static fn(): array => [], TruthSourceOperation::Update);
        TruthSourceRegistry::checkCanWriteItem(self::COLLECTION, '2', static fn(): array => [], TruthSourceOperation::Remove);
    ...
    public function testDbRefusalNamesTheOperationAndWhatIsAllowed(): void
    {
        ...
        TruthSourceRegistry::checkCanWriteItem(self::COLLECTION, '7', static fn(): array => [], TruthSourceOperation::Update);
    }
