...
| [catalog-backed-accessors.md](catalog-backed-accessors.md) | PHP | reading a value out of `Hilos::$env` or `Hilos::$setting` — the index is the one way in, and a typed method beside it is not added |
