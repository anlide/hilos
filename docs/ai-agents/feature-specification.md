...
1. **Clarifying questions**
   ...
   - What data is involved (new Entity/Object/Idea, existing tables)?
...
2. **Technical specification format**
   ...
   - Backend: migrations, Entity/Object/Idea changes, agents, routes
...
3. **Request format for executors**
   ...
   - Ordered tasks (migration first, then Entity, Object, Idea, then agent/frontend)
