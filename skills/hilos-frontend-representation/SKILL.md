...
payloads, table rows, or legacy payloads that still call
...
- Runtime-only fields such as presence, connection counters, upload progress,
  and attachment draft internals belong in BrowserContext rows, typed
  frontend state payloads, or table
